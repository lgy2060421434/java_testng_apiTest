...
public class BodyPost {
    ...
    public static Map<String, String> doPost(String url, String params, String isNeedToken, String CaseId) {
...
//			在发送请求前,判断是否有cookie
            ...
            StringEntity postingString = new StringEntity(jsonObject.toJSONString(), ContentType.APPLICATION_JSON);
